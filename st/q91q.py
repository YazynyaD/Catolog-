...
def ct1(brow,ur,otr1,otr2,urli,notwww,namecl,unamecl,city,cityr,ciadress,street,home,adress,numclinic,numtrue,namepers,fio,f,i,o,timework,url,mail,keysl,desc,tupecl,passw,login,numcodcity,numclshot,numn,numpl,shcir,regi,ob,bb,ind):
    ...
    for q in wwww:
        if "mediapure.ru" in q or "82" in q:
            ...
            w=f"http://resrex.ru/how-add-company"
    brow.get(url=w)
    try:
        sleep(1)
        ...
        sleep(1)
        brow.find_element(By.XPATH, "/html/body/div[4]/div[2]/div/a").click()
        sleep(2)
    except Exception:
        print("Ошибка: переход /resrex.ru")
        pass
    try:
    ...
    try:
        ...
        print("Ошибка: ciadress /resrex.ru")
        pass
    try:
    ...
    try:
        ...
        print("Ошибка: numcodcity /resrex.ru")
        pass
    try:
        ...
        print("Ошибка: numclshot /resrex.ru")
        pass
    try:
        ...
        print("Ошибка: timework /resrex.ru")
        pass
    try:
    ...
    try:
        ...
        print("Ошибка: url /resrex.ru")
        pass
    try:
        brow.find_element(By.XPATH, "/html/body/div[3]/div/div/div[1]/div/div/div[2]/form/div[11]/a").click()
        sleep(1)
        brow.find_element(By.XPATH, "/html/body/div[5]/div/div/div[2]/div/div/ul/li[22]/a").click()
        sleep(1)
        brow.find_element(By.XPATH, "/html/body/div[5]/div/div/div[2]/div/div/ul[2]/li[15]/a").click()
    except Exception:
        print("Ошибка: категории /resrex.ru")
        pass
    try:
