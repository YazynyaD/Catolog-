...
def ct1(brow,ur,otr1,otr2,urli,notwww,namecl,unamecl,city,cityr,ciadress,street,home,adress,numclinic,numtrue,namepers,fio,f,i,o,timework,url,mail,keysl,desc,tupecl,passw,login,numcodcity,numclshot,numn,numpl,shcir,regi,ob,bb,ind):
    ...
    try:
        ...
        pass
    # try:
    #     brow.find_element(By.XPATH, "/html/body/table/tbody/tr/td[2]/table/tbody/tr[2]/td/form/table/tbody/tr[4]/td[2]/a").click()
    #     sleep(1)
    #     zz=brow.find_element(By.XPATH, "//*[@id=\"sr\"]")
    #     zz.clear()
    #     zz.send_keys(city)
    #     sleep(1)
    #     brow.find_element(By.XPATH, "/html/body/div/div/table/tbody/tr[1]/td[2]/a/img").click()
    #     sleep(1)
    #     brow.find_element(By.XPATH, "//*[@id=\"r840\"]").click()
    #     sleep(2)
    #     brow.find_element(By.XPATH, "//*[@id="r974"]").click()
    #     sleep(1)
