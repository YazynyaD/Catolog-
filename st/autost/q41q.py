...
def ct1(brow,ur,otr1,otr2,urli,notwww,namecl,unamecl,city,cityr,ciadress,street,home,adress,numclinic,numtrue,namepers,fio,f,i,o,timework,url,mail,keysl,desc,tupecl,passw,login,numcodcity,numclshot,numn,numpl,shcir,regi,ob,bb,ind):
    ...
    try:
        ...
        pass
    try:
        brow.find_element(By.XPATH, "/html/body/div/div/main/div/section/form/div[9]/a").click()
        sleep(2)
        brow.find_element(By.XPATH, "/html/body/div/div/main/div/section/form/div[9]/select/option[13]").click()
        sleep(1)
        brow.find_element(By.XPATH, "/html/body/div/div/main/div/section/form/div[10]/select/option[27]").click()
    except Exception:
        print("Ошибка: категории /msk.damspravku.ru")
        pass
    try:
        sleep(1)
        brow.find_element(By.XPATH, "//*[@id=\"company_terms\"]").click()
    except Exception:
        print("Ошибка: правила /msk.damspravku.ru")
        pass
    try:
        brow.find_element(By.XPATH, "/html/body/div/div/main/div/section/form/div[20]/input").click()
    except Exception:
        print("Ошибка: done /msk.damspravku.ru")
        pass
    try:
        sleep(5)
        ...
        print("Ошибка: get /msk.damspravku.ru")
        curl="non18"
        df = pd.DataFrame({'Карточка': [curl, 188500000]})
        df.to_excel('./st/autost/ex/ur.xlsx') 
        pass
