...
def ct1(brow,ur,otr1,otr2,urli,www,namecl,unamecl,city,cityr,ciadress,street,home,adress,numclinic,numtrue,namepers,fio,f,i,o,timework,url,mail,keysl,desc,tupecl,passw,login,numcodcity,numclshot,numn,numpl,shcir,regi,ob,bb,ind):
    ...
    try:
        ...
        sleep(7)
        # /html/body/div[1]/main/div/div[2]/form/div[2]/div[1]/div/div/div/div/select[2]/option[1]
    ...
    try:
        ...
        print("Ошибка: done /tvoyaspravka")
        pass
    try:
        sleep(2)
        brow.get(url="https://saratov.tvoyaspravka.ru/add_company")
        sleep(1)
        brow.find_element(By.XPATH, "/html/body/div[1]/header/div/div[1]/div[1]/a[1]").click()
        sleep(1)
