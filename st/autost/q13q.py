...
def ct1(brow,ur,otr1,otr2,urli,notwww,namecl,unamecl,city,cityr,ciadress,street,home,adress,numclinic,numtrue,namepers,fio,f,i,o,timework,url,mail,keysl,desc,tupecl,passw,login,numcodcity,numclshot,numn,numpl,shcir,regi,ob,bb,ind):
    ...
    try:
        ...
        pass
    try:
        brow.find_element(By.XPATH, "/html/body/table[2]/tbody/tr/td[1]/form/table/tbody/tr[17]/td/input").click()
    except Exception:
        print("Ошибка: done /medfirms.ru")
        pass
    try:
        sleep(3)
        zz=brow.find_element(By.XPATH, "/html/body/table[2]/tbody/tr/td[1]/p/table/tbody/tr[1]/td[2]/textarea").text
        zz=zz[9:]
        zz=zz[:-108]
        curl=zz
