...
def ct1(brow,ur,otr1,otr2,urli,notwww,namecl,unamecl,city,cityr,ciadress,street,home,adress,numclinic,numtrue,namepers,fio,f,i,o,timework,url,mail,keysl,desc,tupecl,passw,login,numcodcity,numclshot,numn,numpl,shcir,regi,ob,bb,ind):
    ...
    try:
        ...
        pass
    try:
        brow.find_element(By.XPATH, "/html/body/div[1]/main/div/div/form/fieldset[6]/input").click()
    except Exception:
        print("Ошибка: done /feech.org")
        pass
    try:
        brow.get(url="https://feech.org/user/company")
        sleep(1)
        st=brow.find_element(By.XPATH, "/html/body/div[1]/main/div/div/div/div/a[2]")
        st=st.find_element(By.__getattribute__, "href").text
        brow.get(url=st)
        # brow.find_element(By.XPATH, "/html/body/div[1]/main/div/div/div/div/a[2]").click()
        sleep(3)
