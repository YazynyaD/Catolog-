...
def ct1(brow,ur,otr1,otr2,urli,notwww,namecl,unamecl,city,cityr,ciadress,street,home,adress,numclinic,numtrue,namepers,fio,f,i,o,timework,url,mail,keysl,desc,tupecl,passw,login,numcodcity,numclshot,numn,numpl,shcir,regi,ob,bb,ind):
    ...
    try:
        sleep(2)
        brow.find_element(By.XPATH, "//*[@id=\"user-agreement\"]").click()
    except Exception:
        print("Ошибка: правила /mycompany.su")
        pass
    try:
        brow.find_element(By.XPATH, "/html/body/div[1]/main/div/form/button").click()

    except Exception:
        print("Ошибка: done /mycompany.su")
        pass
    try:
        sleep(5)
