...
def ct1(brow,ur,otr1,otr2,urli,notwww,namecl,unamecl,city,cityr,ciadress,street,home,adress,numclinic,numtrue,namepers,fio,f,i,o,timework,url,mail,keysl,desc,tupecl,passw,login,numcodcity,numclshot,numn,numpl,shcir,regi,ob,bb,ind):
    ...
    try:
        ...
        pass
    try:
        brow.find_element(By.XPATH, "/html/body/main/div[2]/div/form/div[6]/button").click()

    except Exception:
        print("Ошибка: done /телефонырф.рф")
        pass
    try:
        sleep(2)
        brow.get(url="https://телефонырф.рф/%D0%BB%D0%BA/%D1%84%D0%B8%D1%80%D0%BC%D1%8B")
        sleep(2)
        brow.find_element(By.XPATH, "/html/body/main/div[2]/div/div[3]/table/tbody/tr/td[1]/span/a").click()
        sleep(3)
        ...
        print("Ошибка: get /телефонырф.рф")
        curl="non17"
        df = pd.DataFrame({'Карточка': [curl, 188500000]})
        df.to_excel('./st/autost/ex/ur.xlsx') 
        pass
